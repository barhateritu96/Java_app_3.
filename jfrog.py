...
def jfrogUpload():
    url = "http://54.198.45.10:8082/artifactory/example-repo-local/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar"
    file_path = "/var/lib/jenkins/workspace/jfrog2proj/target/kubernetes-configmap-reload-0.0.1-SNAPSHOT.jar"
    username = 'admin'
